...
// window.location.assign(feeling);

// function myFunction() {
//     var x = location.href;
//     document.getElementById("demo").innerHTML = x;

// document.getElementById("searchId").innerHTML = feeling;

// document.getElementById("searchId").action = feeling;
